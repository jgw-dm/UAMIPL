...
parser = argparse.ArgumentParser(
    description='Uncertainty-Aware Multi-Instance Partial-Label Learning via Evidential Deep Model')
parser.add_argument('--lambda_edl', type=float, default=0.1,
                    help='EDL uncertainty mixing weight for attention')
parser.add_argument('--unc_threshold', type=float, default=0.5,
                    help='EDL uncertainty threshold for activation')
parser.add_argument('--uniform_candidate_weighting', type=str2bool, default=False,
                    help='Use fixed uniform candidate-label weighting without dynamic refinement')
parser.add_argument('--shuffle_reliability', type=str2bool, default=False,
                    help='Shuffle instance-level reliability within each bag for sanity-check ablation')
